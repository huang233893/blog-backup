menu:
  ...
  🎤碎念说说:
    碎念站: https://bbs.sumi233.top/ || anzhiyu-icon-lightbulb
    旧版说说: /essay/ || anzhiyu-icon-lightbulb
    ...
    - title: 项目
      item:
        ...
        - name: 导航页
          ...
          icon: https://my.sumi233.top/favicon.ico
        - name: 系统聚合站
          link: https://sys.sumi233.top/
          icon: https://sys.sumi233.top/favicon.ico
        - name: 碎念站
          link: https://bbs.sumi233.top/
          icon: https://sys.sumi233.top/favicon.ico
  ...
  bdageitem:
    ...
    list:
      ...
      - link: https://www.upyun.com/?utm_source=lianmeng&utm_medium=referral
        shields: https://cdn.sumi233.top/gh/huang233893/blog-image-bed@main/top/huang233893/imgs/blog/youpaiyun.svg
        message: 本站项目由又拍云提供CDN加载服务
      ...
      - link: https://www.travellings.cn/
        shields: https://www.travellings.cn/assets/logo.gif
        message: 本站已加入travellings开往
      - link: https://blogscn.fun/
        shields: https://photo.xiangming.site/img/blogscn.png
        message: 本站已加入笔墨迹BLOGS·CN
      - link: https://www.foreverblog.cn/blog/7164.html
        shields: https://www.foreverblog.cn/assets/logo/logo_en_default.png
        message: 本站已加入十年之约
  socialBar:
    enable: true
    centerImg:
