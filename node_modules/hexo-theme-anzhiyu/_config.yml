...
aside:
  ...
  card_announcement:
    enable: true
    content: 你好哇~欢迎来到酥米的小站😊，如有问题可以一起在评论区交流哦！如果没有发现文章更新，请尝试清除网页缓存或者使用`Ctrl + F5`刷新哦 <div id="welcome-info"></div>
  card_weixin:
    enable: true
...
inject:
  head:
  # 自定义css
    - <link rel="stylesheet" href="/custom/css/font.css" media="defer" onload="this.media='all'">
