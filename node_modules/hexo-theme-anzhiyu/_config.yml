menu:
  ...
  🎮好玩的:
    小游戏合集: /game/ || anzhiyu-icon-dice
    电子木鱼: /fish/ || anzhiyu-icon-fish
    周易算卦: /lunar/ || anzhiyu-icon-dice-d20
    AES工具: /aessecret/ || anzhiyu-icon-pencil
    彩蛋: /Fun/ || anzhiyu-icon-dove
...
# Avatar (头像)
avatar:
  img: https://cdn.sumi233.top/gh/huang233893/blog-image-bed/top/huang233893/imgs/blog/userfb6a1018b84ce485.jpg
  effect: false
...
# 左上角网站名字 主页居中网站名字
blog_title_font:
  font_link: /custom/fonts/MiSans-Normal.woff2
  font-family: 'MiSans-Normal'
...
preloader:
  ...
  avatar: https://cdn.sumi233.top/gh/huang233893/blog-image-bed/top/huang233893/imgs/blog/userfb6a1018b84ce485.jpg # 自定加载动画义头像
...
aside:
  ...
  card_announcement:
    enable: true
    content: 你好哇~欢迎来到酥米的小站😊，如有问题可以一起在评论区交流哦！ <div id="welcome-info"></div>
  card_weixin:
    enable: true
...
pjax:
  enable: true
  exclude:
     - https://www.blogsclub.org/badge/www.sumi233.top
     - https://boringbay.com/api/badge/www.sumi233.top
...
LA:
  enable: true
  ck: "3NKPwuJ6RNewnE6i"
  LingQueMonitorID: "3NKQ9huzgM1OAl0X"
...
inject:
  head:
  # 自定义css
    - <link rel="stylesheet" href="/custom/css/font.css" media="only x" onload="this.onload=null;this.media='all'">
    - <link rel="stylesheet" href="/custom/css/flink.css" media="only x" onload="this.onload=null;this.media='all'">
    ...
    - <link rel="stylesheet" href="/custom/css/bilibili.css" media="only x" onload="this.onload=null;this.media='all'">
