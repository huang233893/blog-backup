#article-container
  ...
  if theme.friends_vue && theme.friends_vue.enable
    .title-h2-a
      .title-h2-a-left
        h2(style='padding-top:0;margin:.6rem 0 .6rem') 🎣 点击前往鱼塘钓鱼➡
        a.random-post-start.no-text-decoration(href='/fcircle/')
          i.anzhiyufont.anzhiyu-icon-fish
      .title-h2-a-right
        a.random-post-all.no-text-decoration(href='/about/') 关于酥米
